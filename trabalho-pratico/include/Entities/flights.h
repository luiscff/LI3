...
const char *schedule_departure_date(const FLIGHT *f);
const char *schedule_arrival_date(const FLIGHT *f);
const char *real_departure_date(const FLIGHT *f);
const char *real_arrival_date(const FLIGHT *f);
